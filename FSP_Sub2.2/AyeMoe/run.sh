...
echo "passing param: $DATA_OPENING_INPUT_FILE $DATA_CLOSING_INPUT_FILE $YC_INPUT_FILE executable: $EXECUTABLE" 
echo

#SBB_DEBUG=1; export SBB_DEBUG

echo "======= spawning executable ======="
$EXECUTABLE  $DATA_OPENING_INPUT_FILE $DATA_CLOSING_INPUT_FILE  $YC_INPUT_FILE  2> $ERROR_LOGFILE >&1
